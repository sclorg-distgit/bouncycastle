...
%check
# disable test due invalid certificate:
...
%changelog
* Mon Aug 01 2016 Mat Booth <mat.booth@redhat.com> - 1.54-1.3
- Fix error in postun scriptlet caused by misplaced EOF

* Mon Jul 25 2016 Mat Booth <mat.booth@redhat.com> - 1.54-1.2
- Fix scriptlet requires
- Fix invocation of bnd tool
